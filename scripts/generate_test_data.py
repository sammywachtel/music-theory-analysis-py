...
class ComprehensiveTestGenerator:
    ...
    def get_note_at_interval(
        ...
        return (
            self.INDEX_TO_FLATS[target_idx]
            if use_flats
            else self.INDEX_TO_SHARPS[target_idx]
        )
    ...
    def get_parent_key(self, modal_root: str, mode_name: str) -> str:
        ...
        parent_root = self.get_note_at_interval(
            modal_root, offset, for_key_name_major=True
        )
    ...
    def get_characteristic_progressions(
        self, root: str, mode_name: str, parent_key: Optional[str]
    ) -> List[Progression]:
        ...
        def deg(semitones: int) -> str:
            return adjust_by_parent_key(
                self.get_note_at_interval(root, semitones, prefer)
            )
        ...
        if mode_name == "Mixolydian":
            return [
                Progression(
                    "long",
                    [root, deg(10), deg(5), root],
                    "I-bVII-IV-I",
                    "bVII and IV emphasize modal dominant-less cadence",
                ),
                Progression(
                    "short",
                    [root, deg(10), root],
                    "I-bVII-I",
                    "bVII-I cadence is a core Mixolydian marker",
                ),
                Progression(
                    "seventh",
                    [f"{root}7", deg(5), f"{root}7"],
                    "I7-IV-I7",
                    "dominant-quality tonic is idiomatic in Mixolydian",
                ),
                Progression(
                    "vamp",
                    [root, deg(5)],
                    "I-IV (vamp)",
                    "sustained modal color without functional V",
                ),
                Progression(
                    "foil",
                    [root, deg(7), root],
                    "I-V-I (foil)",
                    "leading-tone V implies functional major over modal",
                ),
            ]
            ...
            return [
                Progression(
                    "long",
                    [f"{root}m", deg(5), deg(10), f"{root}m"],
                    "i-IV-bVII-i",
                    "major IV and bVII with minor tonic",
                ),
                Progression(
                    "short",
                    [f"{root}m", deg(5), f"{root}m"],
                    "i-IV-i",
                    "major IV against minor tonic defines Dorian",
                ),
                Progression(
                    "seventh",
                    [f"{root}m7", f"{deg(5)}maj7", f"{root}m7"],
                    "i7-IVmaj7-i7",
                    "seventh-quality voicings, modal color intact",
                ),
                Progression(
                    "vamp", [f"{root}m", deg(5)], "i-IV (vamp)", "two-chord Dorian vamp"
                ),
                Progression(
                    "foil",
                    [f"{root}m", f"{deg(5)}m", f"{root}m"],
                    "i-iv-i (foil)",
                    "minor iv pulls toward Aeolian",
                ),
            ]
            ...
            return [
                Progression(
                    "long",
                    [f"{root}m", deg(1), deg(10), f"{root}m"],
                    "i-bII-bVII-i",
                    "bII with bVII underscores Phrygian",
                ),
                Progression(
                    "short",
                    [f"{root}m", deg(1), f"{root}m"],
                    "i-bII-i",
                    "flat second is the signature degree",
                ),
                Progression(
                    "seventh",
                    [f"{root}m7", deg(1), f"{root}m7"],
                    "i7-bII-i7",
                    "seventh voicing maintains Phrygian color",
                ),
                Progression(
                    "vamp",
                    [f"{root}m", deg(1)],
                    "i-bII (vamp)",
                    "pedal vamp on tonic and bII",
                ),
                Progression(
                    "foil",
                    [f"{root}m", deg(2), f"{root}m"],
                    "i-II-i (foil)",
                    "natural 2 undermines Phrygian",
                ),
            ]
            ...
            return [
                Progression(
                    "long",
                    [root, deg(2), deg(7), root],
                    "I-II-V-I",
                    "raised 4th via II; keeps functional V at bay contextually",
                ),
                Progression(
                    "long_nov",
                    [root, deg(2), root, deg(2)],
                    "I-II-I-II",
                    "strict Lydian motion emphasizing #4, avoids V",
                ),
                Progression(
                    "short",
                    [root, deg(2), root],
                    "I-II-I",
                    "II (diatonic) emphasizes #4 over IV",
                ),
                Progression(
                    "seventh",
                    [f"{root}maj7", deg(2), f"{root}maj7"],
                    "Imaj7-II-Imaj7",
                    "Imaj7 with implied #11 color",
                ),
                Progression(
                    "vamp", [root, deg(2)], "I-II (vamp)", "two-chord Lydian vamp"
                ),
                Progression(
                    "foil",
                    [root, deg(7), root],
                    "I-V-I (foil)",
                    "authentic cadence reduces Lydian feel",
                ),
            ]
            ...
            return [
                Progression(
                    "long",
                    [f"{root}m", deg(8), deg(10), f"{root}m"],
                    "i-bVI-bVII-i",
                    "natural minor hallmark bVI, bVII",
                ),
                Progression(
                    "short",
                    [f"{root}m", deg(10), f"{root}m"],
                    "i-bVII-i",
                    "Aeolian cadence without leading tone",
                ),
                Progression(
                    "seventh",
                    [f"{root}m7", deg(8), deg(10), f"{root}m7"],
                    "i7-bVI-bVII-i7",
                    "seventh voicings in Aeolian",
                ),
                Progression(
                    "vamp",
                    [f"{root}m", deg(10)],
                    "i-bVII (vamp)",
                    "two-chord Aeolian vamp",
                ),
                Progression(
                    "foil",
                    [f"{root}m", f"{deg(7)}7", f"{root}m"],
                    "i-V7-i (foil)",
                    "leading-tone dominant suggests harmonic minor",
                ),
            ]
            ...
            return [
                Progression(
                    "long",
                    [f"{root}dim", deg(1), f"{deg(6)}m", f"{root}dim"],
                    "i°-bII-v-i°",
                    "Locrian with bII and minor v (no true V)",
                ),
                Progression(
                    "short",
                    [f"{root}dim", deg(1), f"{root}dim"],
                    "i°-bII-i°",
                    "diminished tonic and Neapolitan color",
                ),
                Progression(
                    "seventh",
                    [f"{root}m7b5", deg(1), f"{root}m7b5"],
                    "iø7-bII-iø7",
                    "half-diminished tonic is idiomatic for Locrian",
                ),
                Progression(
                    "vamp",
                    [f"{root}dim", deg(1)],
                    "i°-bII (vamp)",
                    "two-chord Locrian vamp",
                ),
                Progression(
                    "foil",
                    [f"{root}dim", f"{deg(7)}7", f"{root}dim"],
                    "i°-V7-i° (foil)",
                    "true V7 contradicts Locrian",
                ),
            ]
        else:  # Ionian
            return [
                Progression(
                    ...
                    [root, deg(5), root],
                    "I-IV-I",
                    "plagal movement as modal color",
                ),
                Progression(
                    "seventh",
                    [f"{root}maj7", f"{deg(5)}maj7", f"{root}maj7"],
                    "Imaj7-IVmaj7-Imaj7",
                    "Ionian color with 7ths",
                ),
                Progression(
                    "vamp", [root, deg(5)], "I-IV (vamp)", "sustained Ionian color"
                ),
                Progression(
                    "foil",
                    [root, deg(7), root],
                    "I-V-I (foil)",
                    "authentic cadence is functional, not modal",
                ),
            ]

    def has_definitive_modal_characteristics(
        self, chords: List[str], mode_name: str
    ) -> bool:
    ...
    def convert_pattern_to_chords(
        self, root: str, mode: str, pattern: List[str]
    ) -> List[str]:
        ...
        return [
            (
                scale[int(degree) - 1]
                if degree.isdigit() and int(degree) <= len(scale)
                else root
            )
    ...
    def get_scale_notes(self, root: str, mode: str) -> List[str]:
        ...
        major_scale = [
            self.get_note_at_interval(root, ivl, prefer)
            for ivl in [0, 2, 4, 5, 7, 9, 11]
        ]
        return major_scale

    def add_test_case(self, **kwargs):
        """Add a test case to the collection"""
        test_case = TestCase(id=f"test-{self.case_id}", **kwargs)
    ...
    def generate_modal_characteristic_cases(self):
        ...
        for root in self.ROOTS:
            for mode in self.MODES:
                ...
                progressions = self.get_characteristic_progressions(
                    root, mode.name, parent_key
                )
                ...
                if long_prog:
                    ...
                    has_modal_characteristics = (
                        self.has_definitive_modal_characteristics(
                            long_prog.chords, mode.name
                        )
                    )
                    ...
                    self.add_test_case(
                        ...
                        expected_mode=(
                            f"{root} {mode.name}" if has_modal_characteristics else None
                        ),
                        ...
                        theoretical_basis=(
                            ...
                            else "Omit parent key to force boundary decision between modal and functional"
                        ),
                    )
    ...
    def generate_functional_cases(self):
        ...
        functional_patterns = [
            {
                "pattern": ["1", "4", "5", "1"],
                "name": "I-IV-V-I",
                "description": "Classic functional cadence",
            },
            {
                "pattern": ["1", "6", "4", "5"],
                "name": "I-vi-IV-V",
            ...
            },
            {
                "pattern": ["6", "4", "1", "5"],
                "name": "vi-IV-I-V",
                "description": "Pop progression starting on vi",
            },
            {
                "pattern": ["2", "5", "1"],
                "name": "ii-V-I",
                "description": "Jazz ii-V-I",
            },
            {
                "pattern": ["1", "5", "6", "4"],
                "name": "I-V-vi-IV",
                "description": "Pop ballad progression",
            },
        ]
        ...
        for root in self.ROOTS:
            ...
            for functional_pattern in functional_patterns:
                chords = self.convert_pattern_to_chords(
                    root, "major", functional_pattern["pattern"]
                )
    ...
    def generate_ambiguous_cases(self):
        ...
        ambiguous_patterns = [
            {
                "chords": ["C", "F", "G", "C"],
                "description": "Could be C major functional or C Ionian modal",
            },
            {
                "chords": ["Am", "F", "C", "G"],
                "description": "Could be A Aeolian or vi-IV-I-V in C",
            },
            {
                "chords": ["D", "G", "A", "D"],
                "description": "Could be D major or D Mixolydian in G",
            },
        ]
    ...
    def generate_cross_modal_cases(self):
        ...
        for root in ["C", "G", "D", "A"]:
            ...
            for mode_name in modes:
                ...
                progressions = self.get_characteristic_progressions(
                    modal_root, mode_name, parent_key
                )
                ...
                for progression in progressions:
                    ...
                    self.add_test_case(
                        ...
                        expected_modal=expected_modal,
                        expected_mode=(
                            f"{modal_root} {mode_name}" if expected_modal else None
                        ),
                    ...
                    if progression.variant == "long":
                        ...
                        self.add_test_case(
                            ...
                            theoretical_basis=(
                                ...
                                if has_modal_characteristics
                                else "Boundary test without parent-key context"
                            ),
                        )
    ...
    def export_to_json(self) -> str:
        ...
        for category in [
            ...
            categories[category] = len(
                [t for t in self.test_cases if t.category == category]
            )
...
def export_comprehensive_test_cases():
    ...
    with open("./tests/generated/comprehensive-modal-test-cases.csv", "w") as f:
        f.write(csv_output)
    print(
        "📊 CSV export saved to ./tests/generated/comprehensive-modal-test-cases.csv for manual review"
    )
    ...
    a_aeolian_case = next(
        (
            tc
            for tc in test_cases
            if tc.expected_mode == "A Aeolian" and "i-bVI-bVII-i" in tc.description
        ),
        None,
    )
    ...
    if a_aeolian_case:
        ...
        print(
            f'     Expected: {"MODAL" if a_aeolian_case.expected_modal else "FUNCTIONAL"} ({a_aeolian_case.expected_mode or "none"})'
        )
